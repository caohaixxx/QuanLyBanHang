                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class="detail">
                                    ...
                                    @if (isset($product->productDetail) && count($errors) == 0)
                                        @foreach ($product->productDetail as $key => $productDetail)
                                            <div class="pro-item">
                                                <div class="item">
                                                    <label for="exampleInputEmail1">{{ trans('language.color') }}:</label>
                                                    <input type="text" class="form-control" placeholder="Nhập màu"
                                                        name="color[]" style="width: 100%;"
                                                        value="{{ old('color') ? old('color')[$key] : (isset($productDetail->color) ? $productDetail->color : '') }}">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nhập giá"
                                                        name="price[]"
                                                        value="{{ old('price') ? old('price')[$key] : (isset($productDetail->price) ? $productDetail->price : '') }}">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nhập số lượng"
                                                        name="qty[]"
                                                        value="{{ old('qty') ? old('qty')[$key] : (isset($productDetail->quantity) ? $productDetail->quantity : '') }}">
                                                    @if ($errors->first('qty'))
                                                        <div class="invalid-alert text-danger">
                                                            {{ $errors->first('qty') }}
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <label
                                                        for="exampleInputEmail1">{{ trans('language.color_code') }}:</label>
                                                    <input class="color" name="color_code[]" type="color"
                                                        value="{{ old('color_code') ? old('color_code')[$key] : (isset($productDetail->color_code) ? $productDetail->color_code : '') }}">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="zzz"><i class="fa fa-minus-circle"></i></div>
                                                </div>
                                            </div>
                                        @endforeach
                                    @elseif(old('color'))
                                        @for ($i = 0; $i < count(old('color')); $i++)
                                            <div class="pro-item">
                                                <div class="item">
                                                    <label for="exampleInputEmail1">{{ trans('language.color') }}:</label>
                                                    <input type="text" class="form-control" placeholder="Nhập màu"
                                                        name="color[]" style="width: 100%;"
                                                        value="{{ old('color')[$i] }}">
                                                    @if ($errors->first('color.' . $i))
                                                        <div class="invalid-alert text-danger">
                                                            {{ $errors->first('color.' . $i) }}
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="item">
                                                    <label for="exampleInputEmail1">{{ trans('language.price') }}:</label>
                                                    <input type="text" class="form-control" placeholder="Nhập giá"
                                                        name="price[]" value="{{ old('price')[$i] }}">
                                                    @if ($errors->first('price.' . $i))
                                                        <div class="invalid-alert text-danger">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Nhập số lượng" name="qty[]"
                                                        value="{{ old('qty')[$i] }}">
                                                    @if ($errors->first('qty.' . $i))
                                                        <div class="invalid-alert text-danger">
                                                            {{ $errors->first('qty.' . $i) }}
                                                        </div>
                                                    @endif
                                                ...
                                                <div class="item">
                                                    <label
                                                        for="exampleInputEmail1">{{ trans('language.color_code') }}:</label>
                                                    <input class="color" name="color_code[]" type="color"
                                                        value="{{ old('color_code')[$i] }}">
                                                    @if ($errors->first('color_code.' . $i))
                                                        <div class="invalid-alert text-danger">
                                                            {{ $errors->first('color_code.' . $i) }}
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="item">
        ...
        $('.detail').append(`
            <div class="pro-item">
                ...
                <div class="item">
                    ...
                    <input class="color" name="color_code[]" type="color" value="">
                    @if ($errors->first('color_code'))
                        <div class="invalid-alert text-danger">
                            {{ $errors->first('color_code') }}
                        </div>
